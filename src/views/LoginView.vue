  ...
  <v-container class="fill-height" fluid>
    <v-row align="center" justify="center">
      <v-col cols="12" sm="8" md="4">
        <v-card>
          <v-card-title class="text-h5 text-center pt-6">RPG Character Sheet</v-card-title>
          <v-card-subtitle class="text-center pb-2">Sign in to your account</v-card-subtitle>
          <v-card-text>
